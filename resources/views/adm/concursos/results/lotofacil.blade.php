...
<table class="table">
    ...
    <tbody>
        <tr>
            <td>
                <input class="form-control" type="text" name="results[0][prize_type]" readonly value="15 acertos" />
            </td>
            <td>
        ...
        <tr>
            <td>
                <input class="form-control" type="text" name="results[1][prize_type]" readonly value="14 acertos" />
            </td>
            <td>
        ...
        <tr>
            <td>
                <input class="form-control" type="text" name="results[2][prize_type]" readonly value="13 acertos" />
            </td>
            <td>
        ...
        <tr>
            <td>
                <input class="form-control" type="text" name="results[3][prize_type]" readonly value="12 acertos" />
            </td>
            <td>
        ...
        <tr>
            <td>
                <input class="form-control" type="text" name="results[4][prize_type]" readonly value="11 acertos" />
            </td>
            <td>
