...
<table class="table">
    ...
    <tbody>
        <tr>
            <td>
                <input class="form-control" type="text" name="results[0][prize_type]" readonly value="20 acertos" />
            </td>
            <td>
        ...
        <tr>
            <td>
                <input class="form-control" type="text" name="results[1][prize_type]" readonly value="19 acertos" />
            </td>
            <td>
        ...
        <tr>
            <td>
                <input class="form-control" type="text" name="results[2][prize_type]" readonly value="18 acertos" />
            </td>
            <td>
        ...
        <tr>
            <td>
                <input class="form-control" type="text" name="results[3][prize_type]" readonly value="17 acertos" />
            </td>
            <td>
        ...
        <tr>
            <td>
                <input class="form-control" type="text" name="results[4][prize_type]" readonly value="16 acertos" />
            </td>
            <td>
        ...
        <tr>
            <td>
                <input class="form-control" type="text" name="results[5][prize_type]" readonly value="0 acertos" />
            </td>
            <td>
