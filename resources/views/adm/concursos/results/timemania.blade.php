...
<table class="table">
    ...
    <tr>
        <td>
            <input class="form-control" type="text" name="results[0][prize_type]" readonly value="7" />
        </td>
        <td>
    ...
    <tr>
        <td>
            <input class="form-control" type="text" name="results[1][prize_type]" readonly value="6" />
        </td>
        <td>
    ...
    <tr>
        <td>
            <input class="form-control" type="text" name="results[2][prize_type]" readonly value="5" />
        </td>
        <td>
    ...
    <tr>
        <td>
            <input class="form-control" type="text" name="results[3][prize_type]" readonly value="4" />
        </td>
        <td>
    ...
    <tr>
        <td>
            <input class="form-control" type="text" name="results[4][prize_type]" readonly value="3" />
        </td>
        <td>
            <input class="form-control" type="text" name="results[4][number_winners]" value="{{ isset($concurso->results[4]->number_winners) ? $concurso->results[4]->number_winners : '' }}" />
        </td>
        <td>
            <div class="input-group">
                <span class="input-group-addon">R$</span>
                <input class="form-control maskMoney" type="text" name="results[4][value_prize]" value="{{ isset($concurso->results[4]->value_prize) ? $concurso->results[4]->value_prize : '' }}" />
            </div>
        </td>
    </tr>
    <tr>
        <td>
            <input class="form-control" type="text" name="results[5][prize_type]" value="{{ isset($concurso->results[5]->prize_type) ? $concurso->results[5]->prize_type : '' }}" placeholder="Time" />
        </td>
        <td>
            <input class="form-control" type="text" name="results[5][number_winners]" value="{{ isset($concurso->results[5]->number_winners) ? $concurso->results[5]->number_winners : '' }}" />
        </td>
        <td>
            <div class="input-group">
                <span class="input-group-addon">R$</span>
                <input class="form-control maskMoney" type="text" name="results[5][value_prize]" value="{{ isset($concurso->results[5]->value_prize) ? $concurso->results[5]->value_prize : '' }}" />
            </div>
        </td>
    </tr>
    </tbody>
