    ...
    <div class="accordion accordion-svg-toggle" id="faq">
        ...
        <div class="card border-top-0">
            ...
            <div class="card-header" id="faqHeading9">
                <div class="card-title text-dark d-flex collapsed" data-toggle="collapse" data-target="#faq6" aria-expanded="false" aria-controls="faq6" role="button">
                    <span class="svg-icon svg-icon-primary">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="card-label text-dark pl-4">Quanto é a taxa do {{ env("APP_NAME") }} por cota vendida?</div>
                </div>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
            <div id="faq6" class="collapse" aria-labelledby="faqHeading9" data-parent="#faq" style="">
                <div class="card-body text-dark-50 font-size-lg pl-12">
                    Na {{ env("APP_NAME") }} o seu lucro é garantido! Tendo isso em vista é taxado apenas o valor de 13% na venda de <b>cada</b> cota, visando custear os serviços da plataforma. <br />
                    <b>Por Exemplo:</b> Se o preço da sua cota for R$7,50, será taxado o valor de R$0,97
                </div>
            </div>
            <!--end::Body-->
        </div>
        ...
        <div class="card border-top-0">
            ...
            <div class="card-header" id="faqHeading10">
                <div class="card-title text-dark d-flex collapsed" data-toggle="collapse" data-target="#faq11" aria-expanded="false" aria-controls="faq11" role="button">
                    <span class="svg-icon svg-icon-primary">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="card-label text-dark pl-4">Devo comprar cotas após criar meu Bolão?</div>
                </div>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
            <div id="faq11" class="collapse" aria-labelledby="faqHeading9" data-parent="#faq" style="">
                <div class="card-body text-dark-50 font-size-lg pl-12">
                    <b>Não,</b> na hora da criação do Bolão você deve escolher quantas cotas deseja manter para si - essas cotas não serão disponibilizadas para venda e vantagem disso é que ao ser premiado pela loteria você receberá a premiação proporcional a quantidade de cotas que possui.  
                </div>
            </div>
            <!--end::Body-->
        </div>
        ...
        @if (isset($allFaq) && $allFaq)
            ...
            <div class="card border-top-0">
                ...
                <div id="faq7" class="collapse" aria-labelledby="faqHeading3" data-parent="#faq" style="">
                    <div class="card-body text-dark-50 font-size-lg pl-12">
                        A equipe {{ env("APP_NAME") }} visa prestar serviços de excelência aos seus clientes, 
                        com o máximo de transparência, responsabilidade e segurança. 
                    </div>
                </div>
                <!--end::Body-->
            </div>
            ...
            <div class="card border-top-0">
                ...
                <div class="card-header" id="faqHeading6">
                    <div class="card-title text-dark d-flex collapsed" data-toggle="collapse" data-target="#faq8" aria-expanded="false" aria-controls="faq8" role="button">
                        <span class="svg-icon svg-icon-primary">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <!--end::Header-->
                <!--begin::Body-->
                <div id="faq8" class="collapse" aria-labelledby="faqHeading6" data-parent="#faq" style="">
                    <div class="card-body text-dark-50 font-size-lg pl-12">
                        As principais vantagens de utilizar o site da {{ env("APP_NAME") }} para apostar nas loterias da caixa: 
                        <ul class='ps-2'>
                            <li>✲ Aposta lucrativa, onde você ganha o lucro das vendas de suas cotas.</li>
                            <li>✲ Aumento considerável em suas chances de ser premiado</li>
                            <li>✲ Comodidade de um serviço online.</li>
                            <li>✲ Serviço seguro, transparente e responsável.</li>
                        </ul>
                    </div>
                </div>
                <!--end::Body-->
            ...
            <div class="card border-top-0">
                ...
                <div class="card-header" id="faqHeading7">
                    <div class="card-title text-dark d-flex collapsed" data-toggle="collapse" data-target="#faq9" aria-expanded="false" aria-controls="faq9" role="button">
                        <span class="svg-icon svg-icon-primary">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <div class="card-label text-dark pl-4">Posso fazer jogos individuais na {{ env('APP_NAME') }}?</div>
                    </div>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <div id="faq9" class="collapse" aria-labelledby="faqHeading7" data-parent="#faq" style="">
                    <div class="card-body text-dark-50 font-size-lg pl-12">
                        Para melhor atendermos nossos clientes, disponibilizamos a modalidade de jogos individuais (basta selecionar a opção de "manter as cotas" para sí, na criação do bolão) e bolões em grupo.
                        Os bolões em grupo são públicos e são disponibilizados no site para venda, onde com facilidade qualquer um pode comprar!
                        Em caso de premiações, o valor do prêmio final do bolão é dividido proporcionalmente pelas cotas de cada participante, enquanto o criador do bolão será remunerado pelas vendas das cotas (incluso uma taxa em % para custear os serviços da plataforma).
                    </div>
                </div>
                <!--end::Body-->
            </div>
            ...
            <div class="card border-top-0">
                ...
                <div class="card-header" id="faqHeading8">
                    <div class="card-title text-dark d-flex collapsed" data-toggle="collapse" data-target="#faq10" aria-expanded="false" aria-controls="faq10" role="button">
                        <span class="svg-icon svg-icon-primary">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <div class="card-label text-dark pl-4">Como posso comprar créditos?</div>
                    </div>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <div id="faq10" class="collapse" aria-labelledby="faqHeading8" data-parent="#faq" style="">
                    <div class="card-body text-dark-50 font-size-lg pl-12">
                        Para fazer a compra de créditos basta acessar a <a href='{{ route("web.credits.index") }}'>página de créditos</a>
                        Ao acessar a página, selecione a quantidade de créditos desejada e prossiga as etapas. Ao final da compra, você receberá um e-mail que é o recibo da transação.
                    </div>
                </div>
                <!--end::Body-->
            </div>
