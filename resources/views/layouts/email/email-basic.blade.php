...
<head>
    ...
    <title>Lotos Online - @yield('titleEmail')</title>
    <style type="text/css">
        ...
        * #section background style
			...
			*/
        #bodyCell{
            /*@editable*/ border-top:4px solid #5271FF;
        }
        ...
        * #section body link
        ...
        .templateButton{
            /*@editable*/ background-color:#3FCFBB;
            /*@editable*/ border:0;
            border-collapse:separate !important;
            border-bottom: 4px solid #2FB2A0;
        }
        ...
        * #section button style
        ...
        .templateButton .templateButtonContent {
            padding: 0;
        }

        .templateButton .templateButtonContent a{
            padding: 10px;
            display: block;
        }
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                                        <tr>
                                            <td valign="top" class="headerContent">
                                                <img src="{{ asset('img/header-email.png') }}" style="max-width:600px;" id="headerImage" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- // END HEADER -->
